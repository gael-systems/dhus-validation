...
public class EntitySets {
   ...
   public static Map<String, List<String>> getProperties(ServiceDocument serviceDocument, Edm edm)
      ...
      for (EdmEntitySet entitySet : edm.getEntitySets()) {
         if (names.contains(entitySet.getName())) {
            ...
            entitySetsProperties.put(entitySet.getName(), csvLine);
         }
      }
